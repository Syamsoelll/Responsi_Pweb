    ...
    <div class="main-body">
          <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
              <div class="card bg-custom text-light">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="/assets/img/samsul2.png" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
              ...
              <div class="card mt-3 bg-custom">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-custom text-light">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="feather feather-linkedin mr-2 icon-inline text-primary" viewBox="0 0 16 16" stroke-width="2">
                        <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
                      </svg>LinkedIN</h6>
                    <span class=""><a href="https://www.linkedin.com/in/muhamad-syamsul-hidayat/" target="_blank">Muhamad Syamsul Hidayat</a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-custom text-light">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github mr-2 icon-inline"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>Github</h6>
                    <span class="text-secondary"><a href="https://github.com/Syamsoelll/" target="_blank">Syamsoelll</a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-custom text-light">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram mr-2 icon-inline text-danger"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>Instagram</h6>
                    <span class="text-secondary"><a href="https://www.instagram.com/imsyamsoel/" target="_blank">@imsyamsoel</a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-custom text-light">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook mr-2 icon-inline text-primary"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>Facebook</h6>
                    <span class="text-secondary"><a href="https://www.facebook.com/Syamsuldre97/" target="_blank">Sam</a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-custom text-light">
                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="feather feather-whatsapp mr-2 icon-inline text-success" viewBox="0 0 16 16">
                    ...
                    <span class="text-secondary"><a href="https://wa.me/+6289653883906" target="_blank">Samsul</a></span>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-md-8">
              <div class="card mb-3 bg-custom text-light">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-3">
              ...
              <div class="row gutters-sm">
                <div class="col-sm-12 mb-3">
                  <div class="card h-100 bg-custom text-light">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3">My Skills</h6>
                      <div class="d-flex justify-content-center align-items-center">

                        <!-- C -->
                        <div class="d-flex justify-content-center align-items-center mb-3 mr-3" style="width: 13rem;">
                      ...
                      <!-- C++ -->
                      <div class="d-flex justify-content-center align-items-center mb-3 mr-3" style="width: 13rem;">
                        <svg class="" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                      ...
                      <!-- CSS -->
                      <div class="d-flex justify-content-center align-items-center mb-3" style="width: 13rem;">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
